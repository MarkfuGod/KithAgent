...
**语言 / Languages:** [English](README.md) · 中文

> **Status: 正在积极开发中。** 欢迎试用；遇到问题、有想法或者想参与开发，请到 [GitHub Issues](https://github.com/MarkfuGod/KernelAgent/issues) 反馈。API、配置、CLI 都可能在稳定前继续变化。
